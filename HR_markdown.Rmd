...
rownames(mean_dept) <- c("accounting","HR","IT", "management","marketing","product management","researche and development","sales","support","technical")
...
rownames(sd_dept) <- c("accounting","HR","IT", "management","marketing","product management","researche and development","sales","support","technical")
...
rownames(min_dept) <- c("accounting","HR","IT", "management","marketing","product management","researche and development","sales","support","technical")
...
rownames(max_dept) <- c("accounting","HR","IT", "management","marketing","product management","researche and development","sales","support","technical")
...
# Apply factors and scale the data 
...
=======
## Part 1
>>>>>>> 6b92b1097f282103a038378de882e53602fc0929
...
<<<<<<< HEAD
To sum up, we can say that the employees who left:
